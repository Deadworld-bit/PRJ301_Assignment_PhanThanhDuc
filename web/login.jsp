    ...
    <body class="text-center">
        ...
        <c:if test="${empty user}">
            <form action="DispatchServlet" method="POST">
                ...
                <br/>
                <br/>
                <a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8084/PRJ301_SE08D_Assignment_Group10/LoginGoogleServlet&response_type=code
                    &client_id=832115264547-rpa369t5rm6q0rkrmd2jqlh3v1o2ojhh.apps.googleusercontent.com&approval_prompt=force">Login With Google</a>  
                <br/>
