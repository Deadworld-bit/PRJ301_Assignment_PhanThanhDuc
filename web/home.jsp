                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="cbPrice" class="form-control">
                                        ...
                                        <option<c:if test="${selected=='0 - 100000'}">
                                                selected="true"
                                            </c:if>>0 - 100000</option>
                                        <option<c:if test="${selected=='100000 - 300000'}">
                                                selected="true"
                                            </c:if>>100000 - 300000</option>
                                        <option<c:if test="${selected=='300000 - 500000'}">
                                                selected="true"
                                            </c:if>>300000 - 500000</option>
                                        <option<c:if test="${selected=='500000 - 1000000'}">
                                                selected="true"
                                            </c:if>>500000 - 1000000</option>
                                        <option<c:if test="${selected=='1000000 Above'}">
                                                selected="true"
                                            </c:if>>1000000 Above</option>
                                    </select> 
                                </div>
                                <div class="col-lg-2">
